...
import static top.reminisce.coolnetblogcore.common.CommonGlobalRef.ACCOUNT_AT_NOT_RIGHT_TIPS;
...
public class LoginSpringSecurityServiceImpl extends AbstractHomeQueryService implements UserDetailsService{
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        if (ObjectUtils.isEmpty(sysAdmin)){
            throw new BlogAccountNotRightExceptionTips(ACCOUNT_AT_NOT_RIGHT_TIPS);
        }
